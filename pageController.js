...
const fs = require('fs');
let datos = ["VLX.L","VOLO.ST","TIXT","LITE", "VIAV","NA9.DE","GDI.TO","MTY.TO","GSY.TO","PBH","BERY","SUS.L","IL8.F","AMZN","P1E0.F","GOOG","MRL.L","6NF.F","CNSWF","CTS.TO","DOLE","ZTS","IDXX","MCD","HLT","CMG","LOW"]
